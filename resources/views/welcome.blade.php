                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 pr-md-1">
                            <div class="form-group">
                               ...
                               <input type="text" class="form-control" name="departure_address" placeholder="Departure Address" required>
                            </div>
                        </div>
                        <div class="col-md-4 pl-md-1">
                            <div class="form-group">
                                <label for="address" >Delivery Address</label>
                                <input type="text"  class="form-control"  name="delivery_address" placeholder="Delivery Address" required>
                            </div>
                        </div>
                        <div class="col-md-4 px-md-1">
                            <div class="form-group">
